          ...
          <form class="form-horizontal" id="jobDesk" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-sm-12 col-md-8 col-lg-8">
                ...
                <input type="hidden" id="userIdUnique" value="{{ Request::segment(3) }}" />
                <div id="pekerjaanEditor" class="editor-form">{!! $user -> jobdeskSup !!}</div>
                <hr class="my-4">
              </div>
                <hr class="mb-4">
                <div class="w-100 text-left">
                  <button class="btn btn-lg btn-success" id="submit_jobdesk" type="submit"><i class="ri-health-book-line"></i> Tambah</button>
                </div>
              </div>
            </div>
          </form>
